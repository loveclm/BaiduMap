    ...
    <section class="content">
        <div class="container">
            <div class="row custom-info-row">
                ...
                <input type="text" class="col-sm-4" id="courseprice" value="<?php echo isset($course) ? $course->price : '';?>" style="display: none;"/>
            ...
            <div class="row custom-info-row">
                ...
                <input style="text-align: right;" type="text" class="col-sm-1" id="courserate" value="<?php echo isset($course) ? floatval($course->discount_rate)*100 : '';?>">
                <label>%</label>
            </div>
        </div>
        <div class="container">
